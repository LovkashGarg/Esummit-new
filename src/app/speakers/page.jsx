                ...
                <div className="flex-col justify-end items-center lg:gap-16 gap-10 flex">
                    ...
                    <div className="flex-col justify-center items-center gap-10 flex">
                        <div className="flex-col justify-start items-center gap-2.5 flex">
                            <h2 className="text-center text-white md:text-6xl text-5xl font-bold font-manrope leading-normal"> Speakers Revealing Soon !!!</h2>
                            <p className="text-center text-gray-500 text-base font-normal leading-relaxed">Just 5 days remaining until the big reveal of our Speakers!</p>
                        </div>
                        
                        <div className="w-full flex-col justify-center items-center gap-5 flex">
                            <h6 className="text-center text-emerald-400 text-base font-semibold leading-relaxed">Launched Date: Oct 2, 2024</h6>
                        </div>
                    </div>
                </div>
